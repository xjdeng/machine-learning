...
def explore_city_data(city_data):
    ...
    # Number of features?
    print "Dimensions of feature matrix: ", housing_features.shape
    print "# of Features: ", int(housing_features.shape[1])
    # Minimum price?
    ...
    print "Standard deviation: ", housing_prices.std()
    ###################################
...
def fit_predict_model(city_data):
    ...
    # regressor.score = performance_metric
    getscore = make_scorer(performance_metric,greater_is_better=False)
    reg = GridSearchCV(regressor,parameters,getscore)
    reg.max_depth = 5
    tmp = reg.fit(X,y)
    print tmp.best_estimator_ #mainly to extract max_depth
